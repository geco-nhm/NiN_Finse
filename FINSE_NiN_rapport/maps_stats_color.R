...
snow_h1 <- snow_h1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "Spectral") +
  ...
  labs(title="FINSE SNOW - Areal dekket av hovedtyper", 
       fill="Hovedtype",
       x="NiN hovedtyper",
   ...
   geom_text(aes( label = scales::percent(percent),
                  y= percent ),  vjust = -0.5)
snow_h1
ggsave(filename = "snow_h1.png",plot = snow_h1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
snow_h2 <- snow_h2 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "Spectral") +
  ...
  geom_text(aes( label = scales::percent(percent),
                 y= percent ),  vjust = -0.5)
snow_h2
ggsave(filename = "snow_h2.png",plot = snow_h2, width = 15, height = 10,units = "cm",  device = "png", path = paste0(path, "/ggplots/") )
# # As percentage
...
#   labs(title="Areal dekket av hovedtyper", 
#        fill="Hovedtype",
#        x="NiN hovedtyper",
#        y=expression ("Areal i"~m^2)) 
...
snow_e1 <-snow_e1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "Spectral") +
  ...
  labs(title="FINSE SNOW - Areal dekket av NiN typer", 
       ...
       y=expression ("Areal i"~m^2))
snow_e1
ggsave(filename = "snow_e1.png",plot = snow_e1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/") )
...
snow_e2
ggsave(filename = "snow_e2.png",plot = snow_e2, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
snow_lichen_h1 <-snow_lichen_h1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "YlOrBr") +
  #facet_wrap(~lav)+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE SNOW - Areal av hovedtyper fordelt på lavdekning", 
       fill="Lavdekning (A9-skala)",
       x="Hovedtyper",
       y=expression ("Areal i"~m^2))
snow_lichen_h1
ggsave(filename = "snow_lichen_h1.png",plot = snow_lichen_h1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
snow_lichen_h2 <-snow_lichen_h2 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "YlOrBr") +
  #facet_wrap(~lav)+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE SNOW - Areal av hovedtyper fordelt på lavdekning", 
  ...
  geom_text(aes( label =  round(area, 2), y= area ),
            ...
            color=rgb(100,100,100, maxColorValue=255))
snow_lichen_h2
ggsave(filename = "snow_lichen_h2.png",plot = snow_lichen_h2, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
snow_lichen_e1 <-snow_lichen_e1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "YlOrBr") +
  ...
  labs(title="FINSE SNOW - Areal av NiN typer fordelt på lavdekning", 
       ...
       y=expression ("Areal i"~m^2))
snow_lichen_e1
ggsave(filename = "snow_lichen_e1.png",plot = snow_lichen_e1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
snow_block_h1 <-snow_block_h1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "PuBuGn") +
  #facet_wrap(~blokkmark)+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE SNOW - Areal av hovedtyper fordelt på blokkdekning", 
       fill="Blokkdekning (A9-skala)",
       x="Hovedtyper",
       y=expression ("Areal i"~m^2))
snow_block_h1
ggsave(filename = "snow_block_h1.png",plot = snow_block_h1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
snow_block_h2 <-snow_block_h2 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "PuBuGn") +
  #facet_wrap(~blokkmark)+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE SNOW - Areal av hovedtyper fordelt på blokkdekning", 
  ...
  geom_text(aes( label =  round(area, 2), y= area ),
            ...
            color=rgb(100,100,100, maxColorValue=255))
snow_block_h2
ggsave(filename = "snow_block_h2.png",plot = snow_block_h2, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
snow_block_e1 <-snow_block_e1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "PuBuGn") +
  facet_wrap(~kode_hoved, scales = "free")+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE SNOW - Areal av NiN typer fordelt på blokkdekning", 
       ...
       y=expression ("Areal i"~m^2))
snow_block_e1
ggsave(filename = "snow_block_e1.png",plot = snow_block_e1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
snow_busk_h1 <-snow_busk_h1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "YlGn") +
  #facet_wrap(~busk)+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE SNOW - Areal av hovedtyper fordelt på busksjiktdekning", 
       fill="Busksjiktdekning (A9-skala)",
       x="Hovedtyper",
       y=expression ("Areal i"~m^2))
snow_busk_h1
ggsave(filename = "snow_busk_h1.png",plot = snow_busk_h1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
snow_busk_h2 <-snow_busk_h2 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "YlGn") +
  #facet_wrap(~busk)+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE SNOW - Areal av hovedtyper fordelt på busksjiktdekning", 
  ...
  geom_text(aes( label =  round(area, 2), y= area ),
            ...
            color=rgb(100,100,100, maxColorValue=255))
snow_busk_h2
ggsave(filename = "snow_busk_h2.png",plot = snow_busk_h2, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
snow_busk_e1 <-snow_busk_e1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "YlGn") +
  facet_wrap(~kode_hoved, scales = "free")+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE SNOW - Areal av NiN typer fordelt på busksjiktdekning", 
       fill="Busksjiktdekning (A9-skala)",
       x="Hovedtyper",
       y=expression ("Areal i"~m^2))
snow_busk_e1
ggsave(filename = "snow_busk_e1.png",plot = snow_busk_e1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
flux_h1 <-  flux_h1 + geom_bar(position = "stack",stat = "identity") + 
  ...
  scale_x_discrete(labels = NULL) +
  theme(axis.text.x=element_text(angle=90, hjust=1)) +
  labs(title="FINSE FLUX - Areal dekket av hovedtyper", 
       fill="Hovedtype",
       x="NiN hovedtyper",
       y=expression ("Areal i"~m^2)) +
  geom_text(aes( label = scales::percent(percent),
            ...
            color=rgb(100,100,100, maxColorValue=255))
flux_h1
ggsave(filename = "flux_h1.png",plot = flux_h1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
flux_h2 <- flux_h2 + geom_bar(position = "stack",stat = "identity") + scale_fill_manual(values = palette_paired_13) +
  ...
  geom_text(aes( label = scales::percent(percent),
                 y= percent ),  vjust = -0.5)
flux_h2
ggsave(filename = "flux_h2.png",plot = flux_h2, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
# # As percentage
...
flux_e1 <- flux_e1 + geom_bar(position = "stack",stat = "identity") + scale_fill_manual(values = palette_paired_13) +
  ...
  labs(title="FINSE FLUX - Areal dekket av NiN typer", 
       ...
       y=expression ("Areal i"~m^2))
flux_e1
ggsave(filename = "flux_e1.png",plot = flux_e1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
flux_e2 <- flux_e2 + geom_bar(position = "stack",stat = "identity") + scale_fill_manual(values = palette_paired_13) +
  ...
  geom_text(aes( label = scales::percent(percent), y= percent, digits=2 ),
            ...
            color=rgb(100,100,100, maxColorValue=255))
flux_e2
ggsave(filename = "flux_e2.png",plot = flux_e2, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
flux_lichen_h1 <-flux_lichen_h1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "YlOrBr") +
  #facet_wrap(~lav)+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE FLUX - Areal av hovedtyper fordelt på lavdekning", 
       fill="Lavdekning (A9-skala)",
       x="Hovedtyper",
       y=expression ("Areal i"~m^2))
flux_lichen_h1
ggsave(filename = "flux_lichen_h1.png",plot = flux_lichen_h1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
flux_lichen_h2 <-flux_lichen_h2 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "YlOrBr") +
  #facet_wrap(~lav)+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE FLUX - Areal av hovedtyper fordelt på lavdekning", 
  ...
  geom_text(aes( label =  round(area, 2), y= area ),
            ...
            color=rgb(100,100,100, maxColorValue=255))
flux_lichen_h2
ggsave(filename = "flux_lichen_h2.png",plot = flux_lichen_h2, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
flux_lichen_e1 <-flux_lichen_e1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "YlOrBr") +
  facet_wrap(~kode_hoved, scales = "free")+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE FLUX - Areal av NiN typer fordelt på lavdekning", 
       ...
       y=expression ("Areal i"~m^2))
flux_lichen_e1
ggsave(filename = "flux_lichen_e1.png",plot = flux_lichen_e1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
flux_block_h1 <-flux_block_h1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "PuBuGn") +
  #facet_wrap(~blokkmark)+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE FLUX - Areal av hovedtyper fordelt på blokkdekning", 
       fill="Blokkdekning (A9-skala)",
       x="Hovedtyper",
       y=expression ("Areal i"~m^2))
flux_block_h1
ggsave(filename = "flux_block_h1.png",plot = flux_block_h1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
flux_block_h2 <-flux_block_h2 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "PuBuGn") +
  #facet_wrap(~blokkmark)+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE FLUX - Areal av hovedtyper fordelt på blokkdekning", 
  ...
  geom_text(aes( label =  round(area, 2), y= area ),
            ...
            color=rgb(100,100,100, maxColorValue=255))
flux_block_h2
ggsave(filename = "flux_block_h2.png",plot = flux_block_h2, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
flux_block_e1 <-flux_block_e1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "PuBuGn") +
  facet_wrap(~kode_hoved, scales = "free")+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE FLUX - Areal av NiN typer fordelt på blokkdekning", 
       ...
       y=expression ("Areal i"~m^2))
flux_block_e1
ggsave(filename = "flux_block_e1.png",plot = flux_block_e1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
flux_busk_h1 <-flux_busk_h1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "YlGn") +
  #facet_wrap(~busk)+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE flux - Areal av hovedtyper fordelt på busksjiktdekning", 
       fill="busksjiktdekning (A9-skala)",
       x="Hovedtyper",
       y=expression ("Areal i"~m^2))
flux_busk_h1
ggsave(filename = "flux_busk_h1.png",plot = flux_busk_h1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
flux_busk_h2 <-flux_busk_h2 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "YlGn") +
  #facet_wrap(~busk)+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE flux - Areal av hovedtyper fordelt på busksjiktdekning", 
  ...
  geom_text(aes( label =  round(area, 2), y= area ),
            ...
            color=rgb(100,100,100, maxColorValue=255))
flux_busk_h2
ggsave(filename = "flux_busk_h2.png",plot = flux_busk_h2, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
...
flux_busk_e1 <-flux_busk_e1 + geom_bar(position = "stack",stat = "identity") + scale_fill_brewer(palette = "YlGn") +
  facet_wrap(~kode_hoved, scales = "free")+
  scale_y_continuous(labels = scales::comma_format()) +
  theme(axis.text.x=element_text(angle=90, vjust = 0.5)) + 
  labs(title="FINSE flux - Areal av NiN typer fordelt på busksjiktdekning", 
       ...
       y=expression ("Areal i"~m^2))
flux_busk_e1
ggsave(filename = "flux_busk_e1.png",plot = flux_busk_e1, width = 15, height = 10, device = "png", path = paste0(path, "/ggplots/"))
